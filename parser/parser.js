...
MiniLexer$1.BOOLEAN = 22;
MiniLexer$1.CELL = 23;
MiniLexer$1.ID = 24;
MiniLexer$1.INT = 25;
MiniLexer$1.FLOAT = 26;
MiniLexer$1.STRING = 27;
MiniLexer$1.EQ = 28;
MiniLexer$1.WS = 29;
...
var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      ...
                      null, null, null, null, "BOOLEAN", "CELL", "ID", "INT", 
                      "FLOAT", "STRING", "EQ", "WS" ];
...
MiniParser$1.BOOLEAN = 22;
MiniParser$1.CELL = 23;
MiniParser$1.ID = 24;
MiniParser$1.INT = 25;
MiniParser$1.FLOAT = 26;
MiniParser$1.STRING = 27;
MiniParser$1.EQ = 28;
MiniParser$1.WS = 29;
        ...
        while(_alt!=2 && _alt!=antlr4$1.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                case 1:
                    ...
                    if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MiniParser$1.T__3) | (1 << MiniParser$1.T__4) | (1 << MiniParser$1.T__5) | (1 << MiniParser$1.T__6) | (1 << MiniParser$1.T__7))) !== 0))) {
                ...
                case 3:
                    ...
                    localctx.op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!(_la===MiniParser$1.T__9 || _la===MiniParser$1.T__10)) {
                        localctx.op = this._errHandler.recoverInline(this);
                    }
                    else {
                    	this._errHandler.reportMatch(this);
                ...
                case 4:
                    ...
                    localctx.op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!(_la===MiniParser$1.T__11 || _la===MiniParser$1.T__12)) {
                        localctx.op = this._errHandler.recoverInline(this);
                    }
                    else {
                    	this._errHandler.reportMatch(this);
...
MiniParser$1.prototype.positional_arguments = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MiniParser$1.T__1) | (1 << MiniParser$1.T__17) | (1 << MiniParser$1.T__19) | (1 << MiniParser$1.BOOLEAN) | (1 << MiniParser$1.CELL) | (1 << MiniParser$1.ID) | (1 << MiniParser$1.INT) | (1 << MiniParser$1.FLOAT) | (1 << MiniParser$1.STRING))) !== 0)) {
            this.state = 170;
            this.expr(0);
        }
