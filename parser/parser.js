...
MiniLexer$1.prototype.literalNames = [ null, "'.'", "'['", "']'", "'!'", "'+'", 
                                     "'-'", "'^'", "'*'", "'/'", "'%'", 
                                     "'<'", "'<='", "'>'", "'>='", "'=='", 
                                     "'!='", "'&&'", "'||'", "'|'", "'('", 
                                     "')'", "'function'", "'()'", "':'", 
...
MiniParser$1.prototype.expr = function(_p) {
    ...
    try {
        ...
        case 2:
            ...
            if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MiniParser$1.T__3) | (1 << MiniParser$1.T__4) | (1 << MiniParser$1.T__5))) !== 0))) {
            ...
            if(_alt===1) {
                ...
                case 2:
                    ...
                    if (!( this.precpred(this._ctx, 20))) {
                        throw new antlr4$1.error.FailedPredicateException(this, "this.precpred(this._ctx, 20)");
                    }
                    this.state = 110;
                    localctx.op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MiniParser$1.T__7) | (1 << MiniParser$1.T__8) | (1 << MiniParser$1.T__9))) !== 0))) {
                        localctx.op = this._errHandler.recoverInline(this);
                    }
                    else {
                    	this._errHandler.reportMatch(this);
                ...
                case 3:
                    ...
                    localctx.op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!(_la===MiniParser$1.T__4 || _la===MiniParser$1.T__5)) {
                        localctx.op = this._errHandler.recoverInline(this);
                    }
                    else {
                    	this._errHandler.reportMatch(this);
                ...
                case 4:
                    ...
                    localctx.op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MiniParser$1.T__10) | (1 << MiniParser$1.T__11) | (1 << MiniParser$1.T__12) | (1 << MiniParser$1.T__13))) !== 0))) {
                        localctx.op = this._errHandler.recoverInline(this);
                    }
                    else {
                    	this._errHandler.reportMatch(this);
                ...
                case 5:
                    ...
                    localctx.op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!(_la===MiniParser$1.T__14 || _la===MiniParser$1.T__15)) {
                        localctx.op = this._errHandler.recoverInline(this);
                    }
                    else {
                    	this._errHandler.reportMatch(this);
                ...
                case 8:
                    ...
                    if (!( this.precpred(this._ctx, 24))) {
                        throw new antlr4$1.error.FailedPredicateException(this, "this.precpred(this._ctx, 24)");
                    }
                    this.state = 140;
                    this.match(MiniParser$1.T__0);
                    this.state = 141;
                ...
                case 9:
                    ...
                    if (!( this.precpred(this._ctx, 23))) {
                        throw new antlr4$1.error.FailedPredicateException(this, "this.precpred(this._ctx, 23)");
                    }
                    this.state = 144;
    ...
    try {
        ...
        while(_alt!=2 && _alt!=antlr4$1.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                this._errHandler.sync(this);
                _la = this._input.LA(1);
                if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MiniParser$1.T__0) | (1 << MiniParser$1.T__1) | (1 << MiniParser$1.T__3) | (1 << MiniParser$1.T__4) | (1 << MiniParser$1.T__5) | (1 << MiniParser$1.T__19) | (1 << MiniParser$1.T__21) | (1 << MiniParser$1.T__25) | (1 << MiniParser$1.BOOLEAN) | (1 << MiniParser$1.CELL) | (1 << MiniParser$1.ID) | (1 << MiniParser$1.INT))) !== 0) || _la===MiniParser$1.FLOAT || _la===MiniParser$1.STRING) {
                    this.state = 215;
                    this.expr(0);
                }
