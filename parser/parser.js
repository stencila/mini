...
MiniLexer$1.BOOLEAN = 18;
MiniLexer$1.CELL = 19;
MiniLexer$1.ID = 20;
MiniLexer$1.INT = 21;
MiniLexer$1.FLOAT = 22;
MiniLexer$1.STRING = 23;
MiniLexer$1.EQ = 24;
MiniLexer$1.WS = 25;
...
MiniListener$2.prototype.enterFunction_modifiers = function(ctx) {
};

// Exit a parse tree produced by MiniParser#function_modifiers.
MiniListener$2.prototype.exitFunction_modifiers = function(ctx) {
};
...
MiniParser$1.BOOLEAN = 18;
MiniParser$1.CELL = 19;
MiniParser$1.ID = 20;
MiniParser$1.INT = 21;
MiniParser$1.FLOAT = 22;
MiniParser$1.STRING = 23;
MiniParser$1.EQ = 24;
MiniParser$1.WS = 25;
...
MiniParser$1.RULE_function_modifiers = 6;
MiniParser$1.RULE_function_call = 7;
MiniParser$1.RULE_number = 8;
MiniParser$1.RULE_seq = 9;
...
MiniParser$1.RULE_array = 15;
MiniParser$1.RULE_object = 16;
...
MiniParser$1.prototype.mainExpr = function() {
    ...
    try {
        ...
        case MiniParser$1.T__11:
        case MiniParser$1.T__13:
        case MiniParser$1.T__15:
...
function Function_modifiersContext(parser, parent, invokingState) {
	...
	antlr4$1.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = MiniParser$1.RULE_function_modifiers;
    return this;
}

Function_modifiersContext.prototype = Object.create(antlr4$1.ParserRuleContext.prototype);
...
MiniParser$1.Function_modifiersContext = Function_modifiersContext;

MiniParser$1.prototype.function_modifiers = function() {

    var localctx = new Function_modifiersContext(this, this._ctx, this.state);
    this.enterRule(localctx, 12, MiniParser$1.RULE_function_modifiers);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 130;
...
MiniParser$1.prototype.function_call = function() {
    ...
    this.enterRule(localctx, 14, MiniParser$1.RULE_function_call);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 133;
...
MiniParser$1.prototype.number = function() {
    ...
    this.enterRule(localctx, 16, MiniParser$1.RULE_number);
    try {
        this.state = 145;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
MiniParser$1.prototype.seq = function() {
    ...
    this.enterRule(localctx, 18, MiniParser$1.RULE_seq);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 147;
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(_la===MiniParser$1.T__12) {
            this.state = 148;
            this.match(MiniParser$1.T__12);
            this.state = 149;
            localctx._expr = this.expr(0);
            localctx.items.push(localctx._expr);
            this.state = 154;
...
MiniParser$1.prototype.positional_arguments = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MiniParser$1.T__1) | (1 << MiniParser$1.T__11) | (1 << MiniParser$1.T__13) | (1 << MiniParser$1.T__15) | (1 << MiniParser$1.BOOLEAN) | (1 << MiniParser$1.CELL) | (1 << MiniParser$1.ID) | (1 << MiniParser$1.INT) | (1 << MiniParser$1.FLOAT) | (1 << MiniParser$1.STRING))) !== 0)) {
            this.state = 172;
            this.expr(0);
        }
...
MiniParser$1.prototype.array = function() {
    ...
    this.enterRule(localctx, 30, MiniParser$1.RULE_array);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 199;
...
MiniParser$1.prototype.object = function() {
    ...
    this.enterRule(localctx, 32, MiniParser$1.RULE_object);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 206;
