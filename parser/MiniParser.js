...
MiniParser.prototype.positional_arguments = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(((((_la - 2)) & ~0x1f) == 0 && ((1 << (_la - 2)) & ((1 << (MiniParser.T__1 - 2)) | (1 << (MiniParser.T__4 - 2)) | (1 << (MiniParser.T__6 - 2)) | (1 << (MiniParser.T__7 - 2)) | (1 << (MiniParser.T__8 - 2)) | (1 << (MiniParser.T__24 - 2)) | (1 << (MiniParser.BOOLEAN - 2)) | (1 << (MiniParser.CELL - 2)) | (1 << (MiniParser.ID - 2)) | (1 << (MiniParser.INT - 2)) | (1 << (MiniParser.FLOAT - 2)) | (1 << (MiniParser.STRING - 2)))) !== 0)) {
            this.state = 199;
            this.expr(0);
        }
